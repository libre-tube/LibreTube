...
class LegacyDownloadService : Service() {
    ...
    private fun downloadNotification(intent: Intent) {
        ...
        notification =
            NotificationCompat.Builder(this@LegacyDownloadService, DOWNLOAD_CHANNEL_ID)
    ...
    private fun downloadFailedNotification() {
        val builder = NotificationCompat.Builder(this@LegacyDownloadService, DOWNLOAD_CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_download)
            .setContentTitle(resources.getString(R.string.downloadfailed))
            .setContentText(getString(R.string.fail))
            .setPriority(NotificationCompat.PRIORITY_HIGH)
        with(NotificationManagerCompat.from(this@LegacyDownloadService)) {
    ...
    override fun onDestroy() {
        ...
        stopService(Intent(this@LegacyDownloadService, LegacyDownloadService::class.java))
        super.onDestroy()
    }
}

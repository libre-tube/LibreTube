...
object PreferenceHelper {
    ...
    private val MIGRATIONS =
        arrayOf(
            ...
            PreferenceMigration(5, 6) {
                val currentSpeed =
                    (
                        settings.getString(PreferenceKeys.PLAYBACK_SPEED, null)
    ...
    fun getString(
        key: String?,
        defValue: String,
    ): String = settings.getString(key, defValue) ?: defValue

    fun getBoolean(
        key: String?,
        defValue: Boolean,
    ): Boolean = settings.getBoolean(key, defValue)
    ...
    fun getLong(
        key: String?,
        defValue: Long,
    ): Long = settings.getLong(key, defValue)

    fun getStringSet(
        key: String?,
        defValue: Set<String>,
    ): Set<String> = settings.getStringSet(key, defValue).orEmpty()

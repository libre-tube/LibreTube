...
object ImportHelper {
    ...
    suspend fun importPlaylists(
        ...
        when (importFormat) {
            ...
            ImportFormat.FREETUBE -> {
                ...
                val playlists =
                    playlistFile.orEmpty().map { playlist ->
    ...
    suspend fun exportPlaylists(
        ...
        when (importFormat) {
            ...
            ImportFormat.FREETUBE -> {
                val freeTubeExportDb =
                    playlists
                        .map { playlist ->
                            val videos =
                                playlist.relatedStreams.map { videoInfo ->
                                    FreeTubeVideo(
    ...
    @OptIn(ExperimentalSerializationApi::class)
    suspend fun importWatchHistory(
        context: Context,
        uri: Uri,
        importFormat: ImportFormat,
    ) {
                    ...
                    context.contentResolver
                        ...
                        .map {
                            ...
                            WatchHistoryItem(
                                ...
                                uploaderUrl =
                                    it.subtitles.firstOrNull()?.url?.let { url ->
    ...
    private fun extractYTPlaylistName(
        context: Context,
        uri: Uri,
    ): String? {

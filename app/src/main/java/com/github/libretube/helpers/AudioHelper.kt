...
class AudioHelper(
    ...
    private val minimumVolumeIndex =
        AudioManagerCompat
    ...
    fun getVolumeWithScale(
        maxValue: Int,
        minValue: Int = 0,
    ): Int = volume.normalize(minimumVolumeIndex, maximumVolumeIndex, minValue, maxValue)
}

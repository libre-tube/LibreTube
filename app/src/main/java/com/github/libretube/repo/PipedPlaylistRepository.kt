...
class PipedPlaylistRepository : PlaylistRepository {
    ...
    override suspend fun getPlaylist(playlistId: String): Playlist = RetrofitInstance.authApi.getPlaylist(playlistId)

    override suspend fun getPlaylists(): List<Playlists> = RetrofitInstance.authApi.getUserPlaylists(token)

...
/** A default {@link SabrChunkSource} implementation. */
@UnstableApi
public class DefaultSabrChunkSource implements SabrChunkSource {

  /** {@link SabrChunkSource.Factory} for {@link DefaultSabrChunkSource} instances. */
  public static final class Factory implements SabrChunkSource.Factory {
     ...
     * @param maxSegmentsPerLoad See {@link DefaultSabrChunkSource#DefaultSabrChunkSource}.
     */
    public Factory(
  ...
  private ArrayList<Representation> getRepresentations(DefaultSabrChunkSource this) {
  ...
  protected static final class RepresentationHolder {
    ...
    @Nullable public final SabrSegmentIndex segmentIndex;
    ...
    /* package */ RepresentationHolder copyWithNewRepresentation(
      ...
      @Nullable SabrSegmentIndex oldIndex = representation.getIndex();
      @Nullable SabrSegmentIndex newIndex = newRepresentation.getIndex();

...
import com.github.libretube.player.manifest.RangedUri;
...
/** Utility methods for Sabr streams. */
@UnstableApi
public final class SabrUtil {
   ...
   * @return An instance of {@link SabrManifest}.
   * @throws IOException Thrown when there is an error while loading.
   */
  public static SabrManifest loadManifest(DataSource dataSource, Uri uri) throws IOException {
    return ParsingLoadable.load(dataSource, new SabrManifestParser(), uri, C.DATA_TYPE_MANIFEST);
  }

  /**
   * Loads a {@link Format} for acquiring keys for a given period in a Sabr manifest.
   *
  ...
  public static Format loadFormatWithDrmInitData(DataSource dataSource, Period period)
    ...
    @Nullable
    Format sampleFormat = SabrUtil.loadSampleFormat(dataSource, primaryTrackType, representation);
